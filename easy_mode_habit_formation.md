...
You see this in action when a game's lower levels let you ignore a chunk of the toolkit. Abilities with long cooldowns, secondary systems, tactical items, anything that isn't strictly necessary is likely to be forgotten.
...
This is a design issue that can be fixed by designing levels to force engagement with mechanics that would be otherwise neglected, or by implementing modifiers that spotlight them. 

The broader lesson here is bigger than games: if an environment makes essential behaviours feel like they aren't, people are less inclined to develop them.

So when the game's difficulty spikes, it feels like the system betrayed them. 

Good difficulty design isn't just about knowing when and how to implement horizontal and vertical difficulty; it's about making the right behaviours unavoidable. 